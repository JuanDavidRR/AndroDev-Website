...
//Iconos svg
import { IoLogoJavascript, IoLogoReact } from "react-icons/io";
import { BsWordpress } from "react-icons/bs";
import { FaHtml5, FaCss3, FaReact } from "react-icons/fa";

const About = () => (
  <section className={`${styles.paddings} relative z-[10]`} id="nosotros">
    ...
    >
      {/* Titulos */}
      <motion.div
        className="section__title text-white"
      ...
      >
        ...
        >
          <span className="font-extrabold text-white">AndroDev</span> es una
          agencia especializada en el desarrollo web que busca{" "}
          <span className="font-extrabold text-white"> </span> de los pequeños,
      ...
      >
        <figure>
          ...
          <figcaption className="text-white text-center">HTML</figcaption>
        </figure>
        <figure>
          <FaCss3 className="mx-auto" size="50px" color="#2299f8" />
          <figcaption className="text-white text-center">CSS</figcaption>
        </figure>
        <figure>
          <IoLogoJavascript className="mx-auto" size="50px" color="#f7e018" />
          <figcaption className="text-white text-center">JavaScript</figcaption>
        </figure>
        <figure>
          <BsWordpress className="mx-auto" size="50px" color="#1b769c" />
          <figcaption className="text-white text-center">WordPress</figcaption>
        </figure>
        <figure>
          <FaReact className="mx-auto" size="50px" color="#61dafb" />
          <figcaption className="text-white text-center">React</figcaption>
        </figure>
      </motion.section>
